...
function updateDepth() {
  const rotation1 = plane1.quaternion.clone();
  const rotation2 = plane2.quaternion.clone();
  ...
  plane1.quaternion.copy(rotation1);
  plane2.quaternion.copy(rotation2);
  renderer1.render(scene1, camera1);
  renderer2.render(scene2, camera2);
}

const themeToggleButton1 = document.getElementById("themeToggleButton1");
const themeToggleButton2 = document.getElementById("themeToggleButton2");
...
function applyTheme() {
  ...
  document.documentElement.style.setProperty(
    ...
    isDarkMode ? "#555" : "#4caf50"
  );
  document.documentElement.style.setProperty(
    "--active-button-text-color",
    isDarkMode ? "#fff" : "#fff"
  );
  renderer1.setClearColor(isDarkMode ? 0x000000 : 0xffffff);
  renderer2.setClearColor(isDarkMode ? 0x000000 : 0xffffff);
  themeToggleButton1.classList.toggle("sun", !isDarkMode);
  themeToggleButton1.classList.toggle("moon", isDarkMode);
  themeToggleButton2.classList.toggle("sun", !isDarkMode);
  themeToggleButton2.classList.toggle("moon", isDarkMode);
  renderer1.render(scene1, camera1);
  renderer2.render(scene2, camera2);
}

themeToggleButton1.addEventListener("click", () => {
